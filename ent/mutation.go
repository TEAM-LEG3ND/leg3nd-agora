...
func (m *AccountMutation) SetOauthProvider(ap account.OauthProvider) {
	m.oauth_provider = &ap
}

// OauthProvider returns the value of the "oauth_provider" field in the mutation.
func (m *AccountMutation) OauthProvider() (r account.OauthProvider, exists bool) {
	v := m.oauth_provider
	if v == nil {
		return
	}
...
// OldOauthProvider returns the old "oauth_provider" field's value of the Account entity.
// If the Account object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *AccountMutation) OldOauthProvider(ctx context.Context) (v account.OauthProvider, err error) {
	if !m.op.Is(OpUpdateOne) {
...
func (m *AccountMutation) ResetOauthProvider() {
